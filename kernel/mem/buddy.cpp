...
//         BuddyAllocator::put_page((void *)addr, 1UL << order);
...
// void BuddyAllocator::put_page(void *ptr, size_t frame_count) {
//     if (ptr == nullptr)
//         return;
...
//         BUDDY::ERROR("put_page: 地址 %p 超出物理地址范围", ptr);
//         return;
//     }
//     if ((paddr % 0x1000) != 0) {
//         BUDDY::ERROR("put_pages_in_order: 地址 %p 非页对齐", paddr);
//         return;
//     }
//     if (order < 0 || order > MAX_BUDDY_ORDER) {
//         BUDDY::ERROR("put_pages_in_order: 无效的页数 2^%d", order);
//         return;
//     }

//     put_page_in_order(ptr, order);
// }

// void BuddyAllocator::put_page_in_order(void *ptr, int order) {
//     if (order < 0 || order > MAX_BUDDY_ORDER) {
//         BUDDY::ERROR("put_page_in_order: 无效的order %d", order);
//         return;
//     }
...
// void BuddyAllocator::put_page(void *ptr) {
//     put_page(ptr, 1);
// }

// void *BuddyAllocator::get_free_page(size_t frame_count) {
//     if (frame_count <= 0 ||
...
// void *BuddyAllocator::get_free_pages_in_order(size_t order) {
//     if (order > BuddyAllocator::MAX_BUDDY_ORDER) {
...
//         put_page((void *)buddy_paddr, 1ul << current_order);
...
// void *BuddyAllocator::get_free_page() {
//     return get_free_page(1);
// }

...
namespace kcrt::detail {
    ...
    [[nodiscard]] void *must_heap_alloc(size_t sz, size_t alignment) {
...
void *operator new(size_t sz) {
    return kcrt::detail::must_heap_alloc(sz, alignof(std::max_align_t));
}
...
void *operator new(size_t sz, std::align_val_t alignment) {
    return kcrt::detail::must_heap_alloc(sz, static_cast<size_t>(alignment));
}
...
void *operator new(size_t sz, const std::nothrow_t &) noexcept {
    return kcrt::detail::try_heap_allocate(sz, alignof(std::max_align_t));
}
...
void *operator new(size_t sz, std::align_val_t alignment, const std::nothrow_t &) noexcept {
    return kcrt::detail::try_heap_allocate(sz, static_cast<size_t>(alignment));
}
...
namespace tay {
    void *__alloc(size_t sz, size_t alignment) noexcept {
        return kcrt::detail::try_heap_allocate(sz, alignment);
    }

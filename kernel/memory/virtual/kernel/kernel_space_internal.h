...
namespace memory::detail {
    [[nodiscard]] PhyAddr kernel_symbol_paddr(const char *symbol) noexcept;
    [[nodiscard]] PhyAddr kernel_start_paddr() noexcept;
    [[nodiscard]] PhyAddr kernel_end_paddr() noexcept;
    [[nodiscard]] tay::expected<void, tay::error_code> map_kernel_layout(
        KernelSpace &space) noexcept;

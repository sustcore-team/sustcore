...
namespace rv64 {
    ...
    public:
        ...
        union PTE {
            ...
            struct {
                ...
                umb_t pbmt : 2;  // [61:62] Page-Based Memory Type
                                 // 基于页的内存类型
    ...
    public:
        explicit constexpr SV39PageMan(PhyAddr root) : __root(root) {}
            ...
            for (size_t level = 0; level < tot_levels; level++) {
                ...
                if (!pte.v) {
                    ...
                    loggers::PAGING::DEBUG(
                        "VPN[%d] = %d 处页表项 %p 不存在, 构造为 pte = %p",
                        level, vpn[level], &pte, pte.value);
                }
        ...
        Result<void> clone_mapping_from(SV39PageMan &src,
        ...
        Result<void> merge_from(SV39PageMan &src) noexcept;
    ...
    static_assert(ArchPageManTrait<SV39PageMan>);
}  // namespace rv64

...
namespace laboot {
    ...
    extern "C" _LABOOT_FUNCTION void _laboot_tlb_refill();
    extern "C" _LABOOT_DATA addr_t __laboot_bsp_phys_id;
    extern "C" _LABOOT_DATA addr_t __laboot_cmdline_phys;
    extern "C" _LABOOT_DATA addr_t __laboot_system_table_phys;

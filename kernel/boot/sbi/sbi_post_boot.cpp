...
namespace sbi {
    ...
    _SBI_STRING(SBI_BOOTINFO_TOO_LARGE_MSG) =
    ...
    _SBI_FUNCTION void post_panic(const char *msg) {
        sbi_writes(msg);
        while (true);
    }
    ...
    _SBI_FUNCTION bool region_less(const MemRegion &lhs, const MemRegion &rhs) {

...
#define DTB_DWORD(x) (DTB_WORD(x) << 16 | DTB_WORD((x) + 2))
    ...
    extern "C" _SBI_FUNCTION size_t _sbi_setup() {
        ...
        // 映射内核空间到高地址区
        map_range_in_2m(root_page_table, aligned_kernel_start + KVA_START,
        ...
        map_range_in_2m(root_page_table, aligned_dtb_start + KVA_START,
                        aligned_dtb_end + KVA_START, aligned_dtb_start);

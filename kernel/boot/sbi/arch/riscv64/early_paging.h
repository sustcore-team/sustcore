...
namespace sbi {
    extern "C" char s_sbi, s_sbi_kva, s_sbi_reclaimable, s_sbi_reclaimable_kva, e_sbi_reclaimable,
        e_sbi_reclaimable_kva, ekernel_phys, ekernel, s_init, e_init;
    ...
    using PteType = size_t;  // 页目录项类型

    constexpr PteType PDE_BASE = 0x1;
    constexpr PteType PTE_BASE = 0xF;

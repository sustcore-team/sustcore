...
namespace init {
    ...
    public:
        ...
        [[nodiscard]] kernel::KernelError code() const noexcept {
            ...
            return visit(tay::overloaded{
                ...
                [](const SegAddrOverflow &) noexcept { return Reason::SEG_ADDR_OVERFLOW; },
                ...
                [](const ObjectCreateFailed &) noexcept { return Reason::OBJECT_CREATE_FAILED; },
                [](const ProcessConfigFailed &) noexcept { return Reason::PROCESS_CONFIG_FAILED; },
                ...
                [](const UserCtxConfigFailed &) noexcept { return Reason::USER_CTX_CONFIG_FAILED; },
        ...
        [[nodiscard]] const char *message() const noexcept {
            return visit(tay::overloaded{
                ...
                [](const SegAddrOverflow &) noexcept {
                ...
                [](const ObjectCreateFailed &) noexcept {
                    return "usrboot object creation failed";
                },
                [](const ProcessConfigFailed &) noexcept {
                ...
                [](const UserCtxConfigFailed &) noexcept {
    ...
    private:
        using Storage = tay::variant<
            ImageTooSmall, InvalidMagic, InvalidHeader, InvalidSegmentSize, SegAddrOverflow,
            SegmentOutsideUserRange, SegmentFileRangeInvalid, SegmentUnaligned, ObjectCreateFailed,
            ProcessConfigFailed, VmaCreationFailed, SegmentWriteFailed, InitialStackFailed,
            ThreadCreationFailed, UserCtxConfigFailed, ProcessSubmissionFailed, ThreadAttachFailed>;

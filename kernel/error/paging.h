...
namespace memory {
    ...
    public:
        ...
        [[nodiscard]] kernel::KernelError code() const noexcept {
            ...
            return visit(tay::overloaded{
                ...
                [](const AlreadyMapped &) noexcept { return Reason::ALREADY_MAPPED; },
                ...
                [](const PtAllocFailed &) noexcept { return Reason::PT_ALLOC_FAILED; },
        ...
        [[nodiscard]] const char *message() const noexcept {
            return visit(tay::overloaded{
                ...
                [](const AlreadyMapped &) noexcept { return "page mapping already exists"; },
                ...
                [](const PtAllocFailed &) noexcept { return "page-table page allocation failed"; },
    ...
    private:
        using Storage =
            tay::variant<InvalidRoot, InvalidOwner, InvalidState, IdentifierExhausted,
                         NonCanonicalAddress, UnalignedRange, RangeOverflow, OutsideAddressDomain,
                         InvalidPhysicalAddress, InvalidFlags, MissingMapping, AlreadyMapped,
                         UnexpectedEntry, UnsupportedLeafLevel, PtAllocFailed, OutOfMemory>;

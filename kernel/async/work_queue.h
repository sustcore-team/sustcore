...
namespace kernel::async {
    ...
    public:
         ...
         */
        [[nodiscard]] tay::expected<void, WorkQueueError> start(task::Process &process) noexcept;
        ...
        [[nodiscard]] WorkQueueStatistics statistics() noexcept;
    ...
    private:
        ...
        [[nodiscard]] Worklet *pop_front_locked() noexcept;

        tay::spinlock lock_{};
        worklet_list pending_{};
        cap::ObjectRef<task::Thread> worker_ref_{};
        task::Thread *worker_ = nullptr;
        WorkQueueStatistics statistics_{};
        bool started_            = false;

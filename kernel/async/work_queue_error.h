...
namespace kernel::async {
    ...
    public:
        ...
        [[nodiscard]] kernel::KernelError code() const noexcept {
            ...
            return visit(tay::overloaded{
                ...
                [](const WorkerCreationFailed &) noexcept {
                    return Reason::WORKER_CREATION_FAILED;
                },
    ...
    private:
        using Storage =
            tay::variant<AlreadyStarted, PendingWork, WorkerCreationFailed, WorkerAttachFailed,

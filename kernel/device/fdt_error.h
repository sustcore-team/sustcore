...
namespace device {
    ...
    public:
        ...
        struct AddressTranslationFailed {
            u32_t node_offset = 0;
        };
        ...
        [[nodiscard]] kernel::KernelError code() const noexcept {
            ...
            return visit(tay::overloaded{
                ...
                [](const AddressTranslationFailed &) noexcept {
                    return Reason::ADDRESS_TRANSLATION_FAILED;
                },
    ...
    private:
        using Storage = tay::variant<InvalidBlob, NodeNotFound, MissingProperty, InvalidProperty,
                                     CellCountUnsupported, AddressTranslationFailed,
                                     IntegerOverflow, BootCpuNotFound, CatalogRejected>;
    ...
    /** @brief 在 FirmwareEnumerator 固定虚接口边界归约错误，并优先保留嵌套 cause。 */

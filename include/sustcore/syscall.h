...
#define SYS_MEM_SYNC            (SYSCALL_BASE + 0x24)
#define SYS_VFS_OPENDIR         (SYSCALL_BASE + 0x25)
#define SYS_VFS_OPEN            (SYSCALL_BASE + 0x26)
#define SYS_VFS_READ            (SYSCALL_BASE + 0x27)
#define SYS_VFS_WRITE           (SYSCALL_BASE + 0x28)
#define SYS_VFS_SIZE            (SYSCALL_BASE + 0x29)
#define SYS_VFS_SYNC            (SYSCALL_BASE + 0x2A)
#define SYS_VFS_MKFILE          (SYSCALL_BASE + 0x2B)
#define SYS_VFS_MKDIR           (SYSCALL_BASE + 0x2C)
#define SYS_VFS_GETDENTS        (SYSCALL_BASE + 0x2D)
#define SYS_VFS_UNLINK          (SYSCALL_BASE + 0x2E)
#define SYS_VFS_RMDIR           (SYSCALL_BASE + 0x2F)
#define SYS_VFS_TRUNCATE        (SYSCALL_BASE + 0x30)
#define SYS_VFS_RENAME          (SYSCALL_BASE + 0x31)
#define SYS_VFS_SYMLINK         (SYSCALL_BASE + 0x32)
#define SYS_VFS_LINK            (SYSCALL_BASE + 0x33)
#define SYS_VFS_STAT            (SYSCALL_BASE + 0x34)
#define SYS_VFS_LSTAT           (SYSCALL_BASE + 0x35)
#define SYS_VFS_READLINK        (SYSCALL_BASE + 0x36)
#define SYS_VFS_FSTAT           (SYSCALL_BASE + 0x37)
#define SYS_MNT_CREATE          (SYSCALL_BASE + 0x38)
#define SYS_MNT_MOUNT           (SYSCALL_BASE + 0x39)
#define SYS_MNT_UMOUNT          (SYSCALL_BASE + 0x3A)
#define SYS_MNT_ROOT            (SYSCALL_BASE + 0x3B)
#define SYS_MNT_STATE           (SYSCALL_BASE + 0x3C)
#define SYS_PCB_PROCFS_GET      (SYSCALL_BASE + 0x3D)
#define SYS_PCB_PROCFS_REDIRECT (SYSCALL_BASE + 0x3E)
#define SYS_VFS_FCHOWNAT        (SYSCALL_BASE + 0x3F)
#define SYS_PIPE_CREATE         (SYSCALL_BASE + 0x40)
#define SYS_PIPE_READ           (SYSCALL_BASE + 0x41)
#define SYS_PIPE_WRITE          (SYSCALL_BASE + 0x42)
#define SYS_VFS_GETATTR         (SYSCALL_BASE + 0x43)
#define SYS_VFS_GETATTR_AT      (SYSCALL_BASE + 0x44)
#define SYS_VFS_SETATTR         (SYSCALL_BASE + 0x45)
#define SYS_VFS_SETATTR_AT      (SYSCALL_BASE + 0x46)
#define SYS_VFS_CHOWN           (SYSCALL_BASE + 0x47)
#define SYS_VFS_CHOWN_AT        (SYSCALL_BASE + 0x48)
#define SYS_TCB_TIMEOUT_WAIT    (SYSCALL_BASE + 0x49)
#define SYS_VFS_IOCTL           (SYSCALL_BASE + 0x4A)

 ...
 * @brief 定义 mincstd 标准 C 头兼容层使用的编译器诊断控制宏。
 * @version 0.1.0-dev.1
 * @date 2026-08-02
 *
...
#define SUPPRESS_SELF_ASSIGN _Pragma("clang diagnostic ignored \"-Wself-assign-overloaded\"")
...
#define SUPPRESS_USER_DEFINED_LITERAL_SUFFIX _Pragma("GCC diagnostic ignored \"-Wliteral-suffix\"")
...
#define SUPPRESS_SFINAE_INCOMPLETE
#else
#define SUPPRESS_SFINAE_INCOMPLETE _Pragma("GCC diagnostic ignored \"-Wsfinae-incomplete\"")
#endif

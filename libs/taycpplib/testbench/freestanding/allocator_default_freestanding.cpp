...
static_assert(
    std::is_same_v<tay::list<int>, tay::array_list<int, tay::allocator<int>>>);
static_assert(
    std::is_same_v<tay::set<int>, tay::hash_set<int, tay::allocator<int>>>);
static_assert(
    std::is_same_v<tay::map<int, int>,
                   tay::hash_map<int, int, tay::allocator<map_value>>>);
